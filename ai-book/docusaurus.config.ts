...
const config: Config = {
  ...
  organizationName: 'SuhaibGit', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/...', // Removed as per plan
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'VLA Systems',
              to: '/docs/modules/module4/intro-to-vla',
            },
          ],
        },
        {
